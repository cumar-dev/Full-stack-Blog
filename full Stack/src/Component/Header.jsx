          ...
          <div className="flex items-center gap-2">
            ...
            {isLoggedIn ? (
              ...
              <div className="relative">
                ...
                rounded-full cursor-pointer bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2
                ...
                {/* drodownMenue */}
                {
                  ...
                  <Link to={'/profile'} className="block px-4 py-2 text-gray-700 text-sm hover:bg-gray-100">Your Profile</Link>
                  <Link className="block px-4 py-2 text-gray-700 text-sm hover:bg-gray-100">Manage Aricles</Link>
                  <button onClick={()=> logOut()} className="block px-4 cursor-pointer py-2 text-start text-gray-700 text-sm hover:bg-gray-100 w-full">SingnOut</button>
                </div>   
                  )
                }
